...
@endsection
@section('mybody')
    <form method="POST" action="{{url('inscriptionredacteur')}}">
        @csrf
        <div class="form-row">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                <label for="inputCity">Carte bancaire</label>
                <input type="password" class="form-control" id="inputCity">
            </div>


            <div class="form-group  col-md-6">
                <label for="exampleFormControlFile1">Deposer Cv</label>
                <input type="file" class="form-control-file" id="exampleFormControlFile1">
              </div>
        </div>

        <button type="submit" class="btn btn-primary btn-lg btn-block">Inscrire Rédaction</button>
    </form>
@endsection
